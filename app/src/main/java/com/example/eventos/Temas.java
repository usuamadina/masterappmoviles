...
import static com.example.eventos.EventosAplicacion.eliminarIdRegistro;
...
public class Temas extends AppCompatActivity {
    ...
    public static Boolean consultarSuscripcionATemaEnPreferencias(Context context, String
            tema) {
